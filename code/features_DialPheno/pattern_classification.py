...
class BrkdownClassifier():
    ...
    def vectorize_data(self):
        tfidf_vect = TfidfVectorizer(max_df=0.8, max_features=1000,
                                     ...
                                     ngram_range=(1, 2))
        self.datadf['nouns_kewords'] = self.datadf['noun']+' '+self.datadf['keywords']
    ...
    def hierarchical_clustering(self):
        ...
        for matrixplotarray in tfidf_data:
            ...
            clusterAglo_tfidf = AgglomerativeClustering(n_clusters=5, affinity='euclidean', linkage='complete')
            clusterAglo_tfidf.fit_predict(matrix)
            clusterAglo_wrdembd = AgglomerativeClustering(n_clusters=5, affinity='euclidean', linkage='complete')
        ...
        for matrixplotarray in vector_data:
            ...
            for tfidfwrdembd in Agglocluster_result:
                ...
                print("Silhouette Score is {}, "
                      "and calinski score is {}".format(#metrics.homogeneity_score(classes[0:], labels),
